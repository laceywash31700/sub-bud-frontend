...
const inputStyleMappingClasses = {
  small: 'SubBudTextField-inputSizeSmall',
  medium: 'SubBudTextField-inputSizeMedium',
  large: 'SubBudTextField-inputSizeLarge',
  xlarge: 'SubBudTextField-inputSizeXLarge',
};

const classes = {
  root: 'SubBudTextField-root',
  input: 'SubBudTextField-input',
  inputBorder: 'SubBudTextField-inputBorder',
};
...
export interface SubBudTextFieldProps
  extends Omit<FilledTextFieldProps | StandardTextFieldProps, 'size'> {
  noBorder?: boolean;
  size?: 'small' | 'medium' | 'large' | 'xlarge';
}

function TextField(props: SubBudTextFieldProps) {
  const {
    InputProps = {},
    InputLabelProps,
    noBorder,
